...
class ThumbnailComponent extends Component{
	...
	public function _IsJPEG($filename){
		if(eregi("\.jpg|\.jpeg",$filename)){
			return true;
		}
		
	}
	public function _IsGIF($filename){
		if(eregi("\.gif",$filename)){
			return true;
		}
		
	}
	public function create($filename,$thumb_name,$width,$height){
    ...
    public function crop($filename,$thumb_name,$targ_w,$targ_h,$x,$y,$w,$h){
        $src = $filename;
        ...
        { 
            case 'gif' : 
                ...
                imagegif($dst_r,$thumb_name,100);
                break; 
            case 'png' : 
               
                 imagepng($dst_r,$thumb_name,100);
               
            case 'jpg' : 
            case 'jpeg' : 
                imagejpeg($dst_r,$thumb_name,100);
                break; 
            default : 
                return false; 
                break; 
