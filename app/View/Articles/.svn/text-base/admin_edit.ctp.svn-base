...
<div class="content">
	...
	<?php echo $this->element('tinymce'); ?>
		...
		<div class="row">
			<label>Geo Coordinate</label>
			</div>
			<div class="row">
				Latitude : <input type="text" id="lat" name="lat" value="<?=$post['Article']['lat']?>"/><br/>
				Longitude : <input type="text" id="lon" name="lon" value="<?=$post['Article']['lon']?>"/>
			</div>
		<div class="row">
        	<label>Title</label>
		...
		<textarea id="content" name="content" cols="100" rows="20" class="tinymce">
			...
			echo html_entity_decode($post['Article']['content']);
            ...
            <table width="100%">
                ...
                <tr>
                    ...
                    <td  width="150">
                        ...
                        <div class="btnYes"><?php echo $this->Html->link('Yes',"/admin/articles/edit/{$post['Article']['id']}/toggle_image/?id={$img['id']}&toggle=0");?></div>
                        <?php else: ?>
                        <div class="btnNo"><?php echo $this->Html->link('No',"/admin/articles/edit/{$post['Article']['id']}/toggle_image/?id={$img['id']}&toggle=0"); ?></div>
                        <?php endif;?>
                    </td>
                </tr>
                <?php endforeach; ?>
