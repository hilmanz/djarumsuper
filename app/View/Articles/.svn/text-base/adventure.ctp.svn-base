                    ...
                    <div class="listJournal row2">	
                        ...
                        <div class="w620 fl">
                            <div class="excerpt">
                                ...
                                <div class="rowsBtn">
                                    <?php echo $this->Html->link("Read More &raquo;",array('controller' => 'articles', 'action' => $channel_name, $p['Category']['name_str'],'view',$p['Article']['id']),array('class'=>'readmore2','escape'=>false));?>
                                    <?php 
