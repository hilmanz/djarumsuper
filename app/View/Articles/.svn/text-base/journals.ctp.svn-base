...
<div id="container">
    <div id="content" class="jurnalPage">
        <div class="wrapper">
        	<a href="<?=$this->Html->url('/articles/submit/adventure')?>" class="submitArticle">Punya pengalaman seru? kirim cerita perjalanan kamu disini!</a>
                        ...
                        <div class="w620 fl">
                            <div class="excerpt">
                                <div class="titleBox title">
                                    <h1><?php echo $this->Html->link($p['Article']['title'],array('controller' => 'articles', 'action' => $channel_name, $p['Category']['name_str'],'view',$p['Article']['id']));?></h1>
                                ...
                                <div class="rowsBtn">
								<?php echo $this->Html->link("Read More &raquo;",array('controller' => 'articles', 'action' => $channel_name, $p['Category']['name_str'],'view',$p['Article']['id']),array('class'=>'readmore2','escape'=>false));?></p>
                                <?php 
                                ...
                                <div class="share">
                                   <a href="https://plus.google.com/share?url=<?=$permalink?>" 
                                    ...
                                    <a href="https://twitter.com/share" class="twitter-share-button" data-size='large' data-count='none' 
                                            ...
                                            data-via="myadventure" 
                                            data-text="<?=$twittext?>"
                                            data-hashtags="myadventure"></a>
