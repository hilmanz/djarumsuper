                    ...
                    <div class="hotNewsImg">
                        <?php if(isset($MainImg)&&sizeof($MainImg)>0):
                              echo $this->Html->image("/content/images/medium_{$MainImg[0]['filename']}"
                                                      ,array("width"=>"99%","style"=>"border:4px solid #333"));endif;?>
                    </div>
                </div>
            </div><!-- end .w600 -->
            <div class="w300 fr">
                    ...
                    <div class="titleBox title">
                      <!--
						<?php  if(!empty($Province)&&$Province['name']!='-') :?>
                            <h1>&raquo; <?=strtoupper($Province['name'])?></h1>
                        <?php  else : ?>
                        	<h1>&raquo; INDONESIA</h1>
                        <?php endif;  ?>-->
                ...
                <div class="post-info">
                    ...
                    <div class="share">
                       <?php
                          $twittext = $article['summary'];
                          $twiturl = Configure::read('Custom.Domain').$this->Html->url( "/articles/{$cat['Channel']['name_str']}/{$cat['Category']['name_str']}/view/{$article['id']}");
                          $twittext = substr($twittext,0,140-strlen($twiturl))."... ";
                        ?>
                      <a href="https://plus.google.com/share?url=<?=$twiturl?>" 
                        ...
                        <a href="https://twitter.com/share" class="twitter-share-button" data-text="<?=$twittext?>" data-size='large' data-count='none' data-url="<?php echo $this->Html->url( "/articles/{$cat['Channel']['name_str']}/{$cat['Category']['name_str']}/view/{$article['id']}", true ); ?>" data-via="myadventure" data-hashtags="myadventure"></a>
                ...
                <div class="entry-post" style="padding:20px 0 10px 0">
                    <?php 
                      ...
                      if(strlen($article['youtube_video'])>0){
                       ...
                       ?>
                      <a href="<?=$this->Html->url('/articles/submit/')?>" class="submitArticle" style="float:none;">
                        Punya pengalaman seru? kirim cerita perjalanan kamu disini!
                      </a>
                </div><!-- end .entry-info -->
