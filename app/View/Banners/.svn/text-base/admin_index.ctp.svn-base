        ...
        <div class="tablestyle">
           <table width="100%" >
                ...
                <tr>
                    ...
                    <td valign="top"><?php echo $this->Html->image('/content/banner/thumb_'.$p['Banner']['filename']);?></td>
                    <td valign="top">
                    	<?php if($p['Banner']['banner_type']==1):echo "Sidebar";elseif($p['Banner']['banner_type']==3): echo 'Head Banner';elseif($p['Banner']['banner_type']==4): echo 'Homepage Sidebar';elseif($p['Banner']['banner_type']==5): echo 'Top Small Banner';else:echo "Top Banner";endif;?>
                    </td>
