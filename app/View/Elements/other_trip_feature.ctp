...
<div class="listJournal">
	<div class="titleBox title">
	    <h1><?php echo $this->Html->link("{$f['Article']['title']}","/articles/trip/{$f['Province']['name_str']}/{$f['Category']['name_str']}/view/{$f['Article']['id']}");?></h1>
	</div><!-- end .titleBox -->	
	<div class="w300">
	    <div class="newsImg">
	        <?php echo @$this->Html->image("/content/images/small_".$f['MainImg'][0]['filename'], array(
                                                'url' => array('controller' => 'articles', 
                                                				'action' => "trip",$f['Province']['name_str'],
                                                							$f['Category']['name_str'],
                                                				'view',
                                                				$f['Article']['id'])
                                                ));
	...
	<div class="rows">
	    ...
	    <?php echo $this->Html->link("","/articles/trip/{$f['Category']['name_str']}/view/{$f['Article']['id']}",
