                ...
                <div class="row">
                    <div class="post">
                        <div class="entry">
                            ...
                            <span class="author">Oleh : <a href="#authorProfile" class="showPopup">Jejak Kaki David</a></span>
                        </div><!-- end .entry -->
                        <div class="actionBtn">
                            <a href="#detailEvent" class="commentBtn showPopup">3 Tanggapan</a>
                ...
                <div class="row">
                    <div class="post">
                        <div class="entry">
                            ...
                            <span class="date">Tanggal Event : Selasa, 13 January 2013</span>
                            <span class="author">Oleh : <a href="#authorProfile" class="showPopup">Bill si Petualang</a></span>
                        </div><!-- end .entry -->
                        <div class="actionBtn">
                            <a href="#detailEvent" class="commentBtn showPopup">19 Tanggapan</a>
                            <a href="#reply" class="replyBtn showPopup">Jawab Ajakan</a>
                        </div><!-- end .actionBtn -->
                    </div><!-- end .post -->
                </div><!-- end .row -->
                <div class="row">
                    <div class="post">
                        <div class="entry">
                            ...
                            <span class="date">Tanggal Event : Selasa, 13 January 2013</span>
                            <span class="author">Oleh : <a href="#authorProfile" class="showPopup">Bob</a></span>
                        </div><!-- end .entry -->
                        <div class="actionBtn">
                            <a href="#detailEvent" class="commentBtn showPopup">2 Tanggapan</a>
                            <a href="#reply" class="replyBtn showPopup">Jawab Ajakan</a>
                        </div><!-- end .actionBtn -->
                    </div><!-- end .post -->
                </div><!-- end .row -->
...
<div id="detailEvent" class="popupContainer2">
	<div class="popupContent">
    	...
    	<div class="detailEvent">
            ...
            <p>Siapa yang mau ikut gw? ke raja ampat nih! per orang cuma 850rb, masih butuh 7 orang lagi, yang mau ikut langsung comment disini aja yaaa, atau email ke BillsiPetualang@gmail.com</p>
        </div><!-- end .detailEvent -->
        <div class="comments">
            <div class="row">
                <span class="author">Rina</span>
                <span class="date">12 Desember 2012</span>
                <div class="comment-entry">
                    <p>Ogut minat nih gan! itu bener cuma 850rb?</p>
                </div><!-- end .comment-entry -->
            </div><!-- end .row -->
            <div class="row">
                <span class="author">Furi</span>
                <span class="date">8 Desember 2012</span>
                <div class="comment-entry">
            ...
            <div class="row">
                ...
                <span class="date">1 Desember 2012</span>
                <div class="comment-entry">
                    <p>Donec ullamcorper nulla non metus auctor fringilla. Sed posuere consectetur est at lobortis. Maecenas sed diam eget risus varius blandit sit amet non magna.</p>
                </div><!-- end .comment-entry -->
            </div><!-- end .row -->
