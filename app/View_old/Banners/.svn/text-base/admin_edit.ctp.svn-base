		...
		<div class="row">
	        <label>Banner Type</label>
	       	<select id="banner_type" name="banner_type">
	       		<option value="1" <?php if($banner['Banner']['banner_type']==1):echo "selected='selected'";endif;?>>SideBar Banner (210x240 pixels)</option>
	       		<option value="2" <?php if($banner['Banner']['banner_type']==2):echo "selected='selected'";endif;?>>Top Banner (810x300 pixels)</option>
	       	</select>
        </div>
        <div class="row">
        <div class="row">
